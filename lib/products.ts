...
export const siteConfig = {
  ...
  description:
    'X-Med supplies research peptides and compounds for laboratory and research use, with third-party purity testing, discreet EU shipping, and every vial paired with free bacteriostatic water.',
  supportEmail: 'support@x-med.co',
  disclaimer:
    'All products sold by X-Med are intended strictly for laboratory and in-vitro research use by qualified individuals and institutions. They are not drugs, food, or cosmetics, are not for human or animal consumption, and are not evaluated or approved for the diagnosis, treatment, cure, or prevention of any disease. Nothing on this site constitutes medical advice.',
};
...
export const products: Product[] = [
  {
    ...
    includesWater: true,
    shortDescription:
      'A small-molecule NNMT inhibitor studied for its role in fat-cell metabolism and body-composition research.',
    longDescription: [
    ...
    highlights: ['50mg lyophilized powder', 'NNMT inhibitor research compound', 'Third-party purity tested', 'Free bacteriostatic water included'],
    keywords: ['5-amino-1mq', '5-amino-1mq 50mg', 'buy 5-amino-1mq', 'NNMT inhibitor research'],
    ...
    faqs: [
      { q: 'What is 5-Amino-1MQ used for in research?', a: 'It is studied as a selective NNMT enzyme inhibitor, primarily in metabolic and adipose-tissue research settings.' },
      { q: 'Does this ship with reconstitution water?', a: 'Yes — every order includes one free vial of bacteriostatic water at no extra cost.' },
      { q: 'Is this for human use?', a: 'No. This product is sold strictly for laboratory and in-vitro research use, not for human or animal consumption.' },
      { q: 'How should the vial be stored?', a: 'Store the lyophilized powder refrigerated and protected from light; once reconstituted, keep chilled and use within the timeframe standard for peptide research handling.' },
    ],
  },
  {
    slug: 'nad-500mg',
    ...
    includesWater: true,
    shortDescription:
      'Nicotinamide adenine dinucleotide, a coenzyme central to cellular energy production, studied widely in longevity research.',
    longDescription: [
    ...
    highlights: ['500mg per vial', 'Coenzyme used in mitochondrial research', 'Independently purity tested', 'Free bacteriostatic water included'],
    keywords: ['NAD+ 500mg', 'buy NAD+', 'NAD+ research peptide', 'nicotinamide adenine dinucleotide'],
    ...
    faqs: [
      { q: 'What is NAD+ studied for?', a: 'It is studied for its central role in mitochondrial energy production and cellular aging research.' },
      { q: 'What strength does this vial contain?', a: 'Each vial is manufactured to a stated 500mg strength and verified by third-party testing.' },
      { q: 'Is water included?', a: 'Yes, a free bacteriostatic water vial ships with every NAD+ order.' },
    ],
  },
  {
    slug: 'bpc-157-5mg',
    image: 'https://res.cloudinary.com/tedfhije/image/upload/v1783443781/xmed.co_qw2ulu.png',
    bogo: true,
    specifications: {
      purity: '99.2% - 99.8% (HPLC verified)',
      storage: 'Lyophilized: 2-8°C (Reconstituted: 2-8°C, use within 21 days)',
    ...
    includesWater: true,
    shortDescription:
      'A synthetic 15-amino-acid peptide derived from a body-protective compound, one of the most widely referenced peptides in tissue-repair research.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Widely referenced in tissue-repair literature', 'Third-party tested for purity', 'Free bacteriostatic water included'],
    keywords: ['BPC-157', 'BPC-157 5mg', 'buy BPC-157', 'BPC 157 peptide research'],
    ...
    faqs: [
      { q: 'What is BPC-157 studied for?', a: 'It is studied in preclinical models focused on tissue and gut-lining research.' },
      { q: 'Is BPC-157 often studied with other peptides?', a: 'Yes, it is frequently paired with TB-500 in combined soft-tissue research protocols.' },
      { q: 'What does the vial contain?', a: 'A lyophilized 5mg powder, verified by third-party analysis, plus a free vial of bacteriostatic water.' },
      { q: 'Is this approved for human use?', a: 'No — this is a research-use-only product, not evaluated for human or animal consumption.' },
    ],
  },
  {
    slug: 'tb-500-10mg',
    image: 'https://res.cloudinary.com/tedfhije/image/upload/v1783443542/1_tkluia.png',
    bogo: true,
    specifications: {
      purity: '99.2% - 99.8% (HPLC verified)',
      storage: 'Lyophilized: 2-8°C (Reconstituted: 2-8°C, use within 21 days)',
    ...
    includesWater: true,
    shortDescription:
      'A synthetic fragment of Thymosin Beta-4, studied for its role in cellular migration and tissue-repair research.',
    longDescription: [
    ...
    highlights: ['10mg lyophilized vial', 'Studied for actin/cell-migration research', 'Purity verified by third-party lab', 'Free bacteriostatic water included'],
    keywords: ['TB-500', 'TB-500 10mg', 'buy TB-500', 'Thymosin Beta-4 research'],
    ...
    faqs: [
      { q: 'What is TB-500 derived from?', a: 'It is a synthetic fragment of Thymosin Beta-4, a naturally occurring protein.' },
      { q: 'What is it studied for?', a: 'Its interaction with actin and cell migration pathways in tissue-repair research.' },
      { q: 'Does it ship with water?', a: 'Yes, every TB-500 order includes a free bacteriostatic water vial.' },
    ],
  },
  {
    slug: 'hgh-frag-5mg',
    ...
    includesWater: true,
    shortDescription:
      'A modified fragment of human growth hormone (amino acids 176-191), studied for its isolated effect on lipid metabolism.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Isolated HGH lipolytic fragment', 'Third-party tested', 'Free bacteriostatic water included'],
    keywords: ['HGH Frag 176-191', 'HGH fragment 5mg', 'buy HGH frag', 'growth hormone fragment research'],
    ...
    faqs: [
      { q: 'What part of HGH does this fragment represent?', a: 'Amino acids 176-191, the region associated with lipid-metabolizing research.' },
      { q: 'Is this the same as full HGH?', a: 'No, it is an isolated fragment studied specifically for its metabolic research profile, distinct from full-length growth hormone.' },
    ],
  },
  {
    slug: 'aod9604-5mg',
    ...
    includesWater: true,
    shortDescription:
      'A modified HGH fragment analog, closely related to HGH Frag 176-191, used in comparative metabolic research.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Modified HGH fragment analog', 'Third-party purity verified', 'Free bacteriostatic water included'],
    keywords: ['AOD9604', 'AOD9604 5mg', 'buy AOD9604', 'AOD 9604 research peptide'],
    ...
    faqs: [
      { q: 'How does AOD9604 differ from HGH Frag 176-191?', a: 'It is a structurally modified analog designed for improved research stability, and the two are often studied comparatively.' },
    ],
  },
  {
    ...
    includesWater: true,
    shortDescription:
      'A growth-hormone-releasing hormone (GHRH) analog, extensively referenced in research on visceral fat and pituitary signaling.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'GHRH analog research compound', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['Tesamorelin', 'Tesamorelin 5mg', 'buy Tesamorelin', 'GHRH analog research'],
    ...
    faqs: [
      { q: 'What is Tesamorelin studied for?', a: 'Its role as a GHRH analog stimulating the pituitary\'s natural growth-hormone secretion pathway.' },
      { q: 'Is it studied with other compounds?', a: 'Yes, frequently alongside CJC-1295 and Ipamorelin in secretagogue research protocols.' },
    ],
  },
  {
    slug: 'mots-c-10mg',
    ...
    includesWater: true,
    shortDescription:
      'A mitochondrial-derived peptide studied for its role in metabolic regulation and cellular stress response.',
    longDescription: [
    ...
    highlights: ['10mg lyophilized vial', 'Mitochondrial-derived peptide', 'Purity verified', 'Free bacteriostatic water included'],
    keywords: ['MOTS-c', 'MOTS-c 10mg', 'buy MOTS-c', 'mitochondrial peptide research'],
    ...
    faqs: [
      { q: 'What makes MOTS-c different from other peptides?', a: 'It is encoded by the mitochondrial genome rather than nuclear DNA, which is why it is central to mitochondrial research.' },
    ],
  },
  {
    slug: 'ss-31-50mg',
    ...
    includesWater: true,
    shortDescription:
      'A mitochondria-targeted tetrapeptide studied for its interaction with cardiolipin and cellular energy pathways.',
    longDescription: [
    ...
    highlights: ['50mg lyophilized vial', 'Mitochondria-targeted tetrapeptide', 'Independently tested', 'Free bacteriostatic water included'],
    keywords: ['SS-31', 'SS-31 50mg', 'Elamipretide', 'buy SS-31 research peptide'],
    ...
    faqs: [
      { q: 'What is SS-31 also known as?', a: 'It is often referenced in the literature as Elamipretide.' },
      { q: 'Why is this priced higher than other peptides?', a: 'Its synthesis and mitochondrial-targeting structure make it more complex to manufacture at verified purity.' },
    ],
  },
  {
    slug: 'ipamorelin-5mg',
    ...
    includesWater: true,
    shortDescription:
      'A selective growth-hormone secretagogue peptide, studied for its targeted pituitary signaling without significantly affecting cortisol.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Selective GH secretagogue', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['Ipamorelin', 'Ipamorelin 5mg', 'buy Ipamorelin', 'GH secretagogue research'],
    ...
    faqs: [
      { q: 'What makes Ipamorelin selective?', a: 'Research indicates it targets growth-hormone release with less impact on cortisol and prolactin than older secretagogues.' },
      { q: 'What is it commonly studied with?', a: 'CJC-1295 is the most common research pairing for combined secretagogue studies.' },
    ],
  },
  {
    ...
    includesWater: true,
    shortDescription:
      'A GHRH analog without Drug Affinity Complex, studied for shorter-acting, pulsatile growth-hormone release research.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'No-DAC / Mod GRF 1-29 variant', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['CJC-1295 no DAC', 'CJC-1295 5mg', 'Mod GRF 1-29', 'buy CJC-1295 research'],
    ...
    faqs: [
      { q: 'What does "no DAC" mean?', a: 'It refers to the version without Drug Affinity Complex, associated with shorter-acting, pulsatile signaling in research.' },
    ],
  },
  {
    ...
    includesWater: true,
    shortDescription:
      'A synthetic analog of alpha-melanocyte-stimulating hormone, widely studied for its role in melanocyte and pigmentation research.',
    longDescription: [
    ...
    highlights: ['10mg lyophilized vial', 'Melanocortin receptor research compound', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['Melanotan 2', 'Melanotan 2 10mg', 'buy Melanotan 2', 'MT2 research peptide'],
    ...
    faqs: [
      { q: 'What receptor family does Melanotan 2 target in research?', a: 'It is studied for its interaction with melanocortin receptors involved in pigmentation pathways.' },
    ],
  },
  {
    slug: 'igf-1-lr3-1mg',
    ...
    includesWater: true,
    shortDescription:
      'A long-acting analog of insulin-like growth factor 1, engineered for extended half-life in cellular growth research.',
    longDescription: [
    ...
    highlights: ['1mg lyophilized vial', 'Long-acting IGF-1 analog', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['IGF-1 LR3', 'IGF-1 LR3 1mg', 'buy IGF-1 LR3', 'insulin-like growth factor research'],
    ...
    faqs: [
      { q: 'Why is IGF-1 LR3 supplied at 1mg instead of 5mg?', a: 'It is a substantially more potent research compound, so it is formulated at a lower per-vial mass than peptides like BPC-157 or TB-500.' },
    ],
  },
  {
    slug: 'igf-des-1mg',
    ...
    includesWater: true,
    shortDescription:
      'A truncated IGF-1 variant missing the first three N-terminal amino acids, studied for rapid, localized receptor-binding research.',
    longDescription: [
    ...
    highlights: ['1mg lyophilized vial', 'Truncated IGF-1 variant', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['IGF-1 DES', 'IGF DES 1mg', 'des(1-3)IGF-1', 'buy IGF DES research'],
    ...
    faqs: [
      { q: 'How is IGF-1 DES different from IGF-1 LR3?', a: 'DES is a truncated variant studied for rapid, localized receptor binding, while LR3 is modified for an extended half-life.' },
    ],
  },
  {
    slug: 'igf-des-2mg',
    ...
    includesWater: true,
    shortDescription:
      'The higher-strength 2mg vial of our truncated IGF-1 DES variant, for research programs requiring more material per vial.',
    longDescription: [
    ...
    highlights: ['2mg lyophilized vial', 'Higher-yield IGF-1 DES variant', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['IGF-1 DES 2mg', 'buy IGF DES 2mg', 'des(1-3)IGF-1 2mg'],
    ...
    faqs: [
      { q: 'Should I choose the 1mg or 2mg vial?', a: 'The 2mg vial suits research programs that consume more material per study; the 1mg vial suits smaller-scale work.' },
    ],
  },
  {
    slug: 'dsip-5mg',
    ...
    includesWater: true,
    shortDescription:
      'Delta Sleep-Inducing Peptide, a nonapeptide studied for its association with delta-wave sleep patterns in neuroscience research.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Studied in delta-wave sleep research', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['DSIP', 'DSIP 5mg', 'Delta Sleep-Inducing Peptide', 'buy DSIP research'],
    ...
    faqs: [
      { q: 'What was DSIP originally studied from?', a: 'It was first isolated in research examining rabbit brain activity linked to delta-wave sleep.' },
    ],
  },
  {
    slug: 'selank-5mg',
    ...
    includesWater: true,
    shortDescription:
      'A synthetic heptapeptide analog of tuftsin, studied in Russian and international neuroscience literature for anxiolytic research.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Tuftsin-analog research peptide', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['Selank', 'Selank 5mg', 'buy Selank', 'Selank peptide research'],
    ...
    faqs: [
      { q: 'What compound is Selank analogous to?', a: 'It is a synthetic analog of tuftsin, a naturally occurring immunomodulatory peptide.' },
    ],
  },
  {
    slug: 'pt-141-10mg',
    ...
    includesWater: true,
    shortDescription:
      'A melanocortin-receptor agonist derived from Melanotan 2, studied in research on central nervous system arousal pathways.',
    longDescription: [
    ...
    highlights: ['10mg lyophilized vial', 'CNS melanocortin research compound', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['PT-141', 'Bremelanotide', 'PT-141 10mg', 'buy PT-141 research'],
    ...
    faqs: [
      { q: 'How is PT-141 related to Melanotan 2?', a: 'PT-141 is a metabolite of Melanotan 2, studied for central rather than peripheral melanocortin-receptor activity.' },
    ],
  },
  {
    slug: 'ghk-cu-50mg',
    ...
    includesWater: true,
    shortDescription:
      'A naturally occurring copper-binding tripeptide, extensively studied in dermatological and wound-healing research.',
    longDescription: [
    ...
    highlights: ['50mg lyophilized vial', 'Copper-binding tripeptide', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['GHK-Cu', 'GHK-Cu 50mg', 'buy GHK-Cu', 'copper peptide research'],
    ...
    faqs: [
      { q: 'Where does GHK-Cu occur naturally?', a: 'It is found naturally in human plasma, saliva, and urine, at levels that decline with age.' },
    ],
  },
  {
    ...
    includesWater: true,
    shortDescription:
      'A triple-agonist peptide targeting GIP, GLP-1, and glucagon receptors, among the most studied next-generation metabolic research compounds.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Triple GIP/GLP-1/glucagon agonist', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['Retatrutide', 'Retatrutide 5mg', 'buy Retatrutide', 'triple agonist research peptide'],
    ...
    faqs: [
      { q: 'What receptors does Retatrutide target?', a: 'It is engineered to act on GIP, GLP-1, and glucagon receptors simultaneously.' },
      { q: 'How does the 5mg vial compare to the 10mg vial?', a: 'The 5mg vial suits smaller research batches; the 10mg vial provides more material for larger studies at a lower per-mg cost.' },
    ],
  },
  {
    ...
    includesWater: true,
    shortDescription:
      'The 10mg strength of our triple-agonist Retatrutide research compound, offering more material per vial for larger studies.',
    longDescription: [
    ...
    highlights: ['10mg lyophilized vial', 'Triple GIP/GLP-1/glucagon agonist', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['Retatrutide 10mg', 'buy Retatrutide 10mg', 'Retatrutide research peptide'],
    ...
    faqs: [
      { q: 'Is the 10mg vial more cost-effective?', a: 'Yes, the per-mg cost is lower than the 5mg vial, suiting larger or longer-running research programs.' },
    ],
  },
  {
  ...
  },
  {
    ...
    includesWater: true,
    shortDescription:
      'A dual GIP/GLP-1 receptor agonist, one of the most referenced compounds in current incretin and metabolic research.',
    longDescription: [
    ...
    highlights: ['5mg lyophilized vial', 'Dual GIP/GLP-1 agonist', 'Purity tested', 'Free bacteriostatic water included'],
    keywords: ['Tirzepatide', 'Tirzepatide 5mg', 'buy Tirzepatide', 'dual agonist research peptide'],
    ...
    faqs: [
      { q: 'What receptors does Tirzepatide target?', a: 'It is a dual agonist acting on both GIP and GLP-1 receptors.' },
      { q: 'How does this differ from Retatrutide?', a: 'Tirzepatide acts on two receptor pathways (GIP/GLP-1), while Retatrutide is a triple agonist that also targets glucagon receptors.' },
    ],
  },
  {
    ...
    includesWater: false,
    shortDescription:
      'An orally-available ERR agonist, studied in exercise-mimetic and mitochondrial-biogenesis research, supplied as 30 tablets.',
    longDescription: [
    ...
    highlights: ['30 tablets x 1mg', 'Oral ERR agonist', 'Exercise-mimetic research compound', 'Purity tested'],
    keywords: ['SLU-PP-332', 'SLU-PP-332 tablets', 'buy SLU-PP-332', 'ERR agonist research'],
    ...
    faqs: [
      { q: 'Why tablets instead of a vial?', a: 'SLU-PP-332 is an orally-available small molecule, so it is supplied as tablets rather than a lyophilized injectable vial.' },
      { q: 'Does this need bacteriostatic water?', a: 'No — tablets require no reconstitution.' },
    ],
  },
  {
    ...
    includesWater: false,
    shortDescription:
      'A tripeptide fragment of alpha-MSH (Lysine–Proline–Valine), studied for anti-inflammatory research, supplied as 30 oral pills.',
    longDescription: [
    ...
    highlights: ['30 pills x 500mcg', 'Alpha-MSH tripeptide fragment', 'Oral-route research format', 'Purity tested'],
    keywords: ['KPV peptide', 'KPV pills', 'buy KPV', 'Lysine Proline Valine peptide research'],
    ...
    faqs: [
      { q: 'What is KPV derived from?', a: 'It is a tripeptide fragment derived from the C-terminal portion of alpha-MSH.' },
      { q: 'Is this injectable?', a: 'No — KPV here is formulated as oral pills, not a lyophilized injectable vial.' },
    ],
  },
  {
    slug: 'hgh-100iu-10ml',
    ...
    includesWater: true,
    shortDescription:
      'Recombinant human growth hormone, 100iu multi-dose vial, a foundational reference compound in growth-hormone research.',
    longDescription: [
    ...
    highlights: ['100iu / 10ml multi-dose vial', 'Recombinant human growth hormone', 'Purity and potency tested', 'Free bacteriostatic water included'],
    keywords: ['HGH 100iu', 'buy HGH', 'recombinant growth hormone research', 'HGH 10ml vial'],
    ...
    faqs: [
      { q: 'How is this different from GHRH analogs like Tesamorelin?', a: 'This is the full-length recombinant growth hormone protein itself, whereas Tesamorelin and CJC-1295 are analogs that stimulate its natural release.' },
      { q: 'Is bacteriostatic water included?', a: 'Yes, a free vial ships with every HGH order for reconstitution.' },
    ],
  },
  {
    ...
    includesWater: false,
    shortDescription:
      'Sterile water containing 0.9% benzyl alcohol, used in the laboratory to reconstitute lyophilized peptide vials.',
    longDescription: [
    ...
    highlights: ['2ml vial', '0.9% benzyl alcohol preservative', 'Sterility tested', 'For laboratory reconstitution use'],
    keywords: ['bacteriostatic water', 'bacteriostatic water 2ml', 'buy bacteriostatic water', 'peptide reconstitution water'],
    ...
    faqs: [
      { q: 'Do I need to buy this separately?', a: 'Not necessarily — one free 2ml vial already ships with every peptide order. Buy extra here if you need more.' },
      { q: 'What does the benzyl alcohol do?', a: 'It acts as a preservative, inhibiting bacterial growth so a reconstituted vial can be used more than once in the lab.' },
    ],
  },
];
